...
async function basicExample() {
    ...
    const openaiProvider = (0, index_1.createProvider)({
        id: 'openai',
        type: 'openai',
        name: 'OpenAI',
    ...
    const anthropicProvider = (0, index_1.createProvider)({
        id: 'anthropic',
        type: 'anthropic',
        name: 'Anthropic',
    ...
    const gpt4Model = (0, index_1.createModel)({
        id: 'gpt-4',
        provider: 'openai',
        name: 'GPT-4',
        capabilities: ['text', 'vision', 'function_calling']
    });
    const claudeModel = (0, index_1.createModel)({
    ...
    // Create API clients
    const openaiClient = index_1.ApiClientFactory.create(openaiProvider);
    const anthropicClient = index_1.ApiClientFactory.create(anthropicProvider);
    ...
    console.log('Supported provider types:', index_1.ApiClientFactory.getSupportedProviderTypes());
    console.log('Supported provider IDs:', index_1.ApiClientFactory.getSupportedProviderIds());
    console.log();
