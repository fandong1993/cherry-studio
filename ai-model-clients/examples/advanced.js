...
async function advancedExample() {
    ...
    const clients = providers.map(provider => {
        const client = index_1.ApiClientFactory.create(provider);
    ...
    for (const { provider, client } of clients.slice(0, 2)) { // Just first 2 for demo
        ...
        try {
            ...
            const messages = [
                ...
                { id: '2', role: 'user', content: 'Tell me a short joke about programming.' }
            ];
